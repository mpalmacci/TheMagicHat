...
import com.themagichat.decks.DecksMainAdapter.DeckMainViewHolder;
import com.themagichat.decks.db.MagicHatDb;
import com.themagichat.players.Player;
import com.themagichat.quickaction.ActionItem;
import com.themagichat.quickaction.QuickAction;
...
public class DecksMain extends MagicHatActivity implements OnItemClickListener,
	...
	private void openDeckActivity(Deck d, String type) {
		...
		if (type.equals("Edit")) {
			openDeckActivity = new Intent("com.themagichat.decks.DECKEDIT");
		} else if (type.equals("View")) {
			openDeckActivity = new Intent("com.themagichat.decks.DECKVIEW");
		}
