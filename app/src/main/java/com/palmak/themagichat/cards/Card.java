...
public class Card implements Comparable<Card> {
    ...
    private String sToughness;
    // TODO Handle Card Rarities
    // String rarity;
    private String text;
    private Map<Expansion, URL> expansionImages = new HashMap<Expansion, URL>();
    ...
    public Card(Long id, String name, List<Expansion> expansions) {
        this(id, name);
        this.expansions = expansions;
    }

    public Card(Long id, String name, Map<Expansion, URL> expansionImages,
